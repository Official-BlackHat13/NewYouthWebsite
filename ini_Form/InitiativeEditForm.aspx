<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" Culture="en-GB" ClientIDMode="AutoID" ValidateRequest="false" CodeFile="InitiativeEditForm.aspx.cs" Inherits="ini_Form_InitiativeEditForm" %>
    ...
    <script>
        $(function () {
            ...
            $("#<%=datepicker.ClientID %>").datepicker({
                ...
                useCurrent: false,
                //minDate: '+45D',
                minDate: document.getElementById("<%=datepicker.ClientID%>").value,
                maxDate: '+2Y',
            ...
            $("#<%=txtend.ClientID %>").datepicker({
                ...
                dateFormat: 'dd-mm-yy',
                //minDate: '+45D',
                minDate: document.getElementById("<%=txtend.ClientID%>").value,
                maxDate: '+2Y',
                onSelect: function (dateStr) {
                    var d1 = $(this).datepicker("getDate");
                    d1.setDate(d1.getDate() + 0);
    ...
    <script type="text/javascript">
        function ConfirmDel() {
            ...
            if (confirm("Are You Sure To Delete ?")) {
                ...
                document.getElementById("hdConfirmation").value = confirm_value.value;
            } else {
    ...
    <section>
        <div class="container-fluid">
            <div class="container py-5">
                <div class="container bg-white mt-110">
                        ...
                        <div class="row" style="direction: rtl;">
                            <div class="col-xs-12 text-right">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div id="alertTime" class="notification msgalert" runat="server" visible="false">
                                        <p>The Time is over to edit the form.</p>
                                    </div>
                                </div>


                                <div class="heading-bg">
                                    <h1 class="form-style">نموذج المشاريع أو الفعاليات الشبابية</h1>
                                </div>
                                    ...
                                    <div class="col-12 form-group row mb-3">
                                        ...
                                        <div class="col-sm-9 col-xs-12 pull-right radio radio-info">
                                            <asp:RadioButtonList runat="server" ID="RBIntiativeCatagory" RepeatDirection="Horizontal"
                                                RepeatLayout="Flow" AutoPostBack="true" OnSelectedIndexChanged="RBIntiativeCatagory_SelectedIndexChanged" Enabled="false">
                                        ...
                                        <div class="clearfix">
                                            <asp:Label runat="server" Visible="false" ID="lblAgeMessage" Text="لايمكنك التقديم على(أفراد،مجموعات شبابية،تنظيمات طلابية) في حال تجاوز العمر 35"></asp:Label>
                                        </div>
                                        <hr />
                                    </div>
                                    <asp:HiddenField runat="server" ID="hdConfirmation" ClientIDMode="Static" />
                                    <asp:Panel runat="server" ID="pnlType">
                                        <div class="col-12 form-group row mb-3">
                                            <label class="col-sm-3 col-xs-12 control-label text-lg-left pt-2" for="inputRounded">
                                                نوع الطلب
                                            ...
                                            <div class="col-sm-2 col-xs-8 pull-right radio radio-info">
                                                <asp:RadioButton runat="server" ID="RBindivitual" GroupName="type" Text="مشروع" RepeatDirection="Horizontal"
                                                    RepeatLayout="Flow" AutoPostBack="true" OnCheckedChanged="RBindivitual_CheckedChanged" Enabled="false"></asp:RadioButton>
...
"><i class="fa fa-question-circle"></i></asp:Label>
                                            ...
                                            <div class="col-sm-4 col-xs-8 pull-right radio radio-info">
                                                <asp:RadioButton runat="server" ID="RBForum" RepeatDirection="Horizontal" GroupName="type"
                                                    Text="فعالية (معرض،ملتقى،مؤتمر) " AutoPostBack="true" RepeatLayout="Flow" OnCheckedChanged="RBForum_CheckedChanged" Enabled="false"></asp:RadioButton>
...
"><i class="fa fa-question-circle"></i></asp:Label>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UPType">
                                        <ContentTemplate>
                                            <asp:Panel runat="server" ID="pnlOthr">
                                                <%--   <div class="text-2 text-danger" style="font-family: Tahoma;">
                            1st, 2nd, 3rd, 4th, 5th radio to 1st radio   
                        </div>--%>
                                                ...
                                                <%--  <div class="text-2 text-danger" style="font-family: Tahoma;">
                            1st, 2nd, 3rd, 4th, 5th radio to 2nd radio  
                        </div>--%>
                                                ...
                                                <div class="col-12 form-group row mb-3">
                                                    ...
                                                    <label class="col-sm-3 control-label pull-right">اسم مقدم الطلب(حسب البطاقة المدنية)  </label>
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                                            <div class="input-append">
                                                                ...
                                                                <%--<asp:LinkButton ID="lnkfpCivilID" runat="server" Text="View" OnCommand="lnkfpCivilID_Command" ></asp:LinkButton>--%>
                                                                <a href="" target="_blank" runat="server" visible="false" id="fpCivilID_a">View Document</a>
                                        ...
                                        3rd radio to 1st, 2nd radio
                                                ...
                                                <div class="col-12 form-group row mb-3" id="div_authorization" runat="server">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        ...
                                                        <%--<asp:LinkButton ID="lnkfpAutorization" runat="server" Text="View" OnCommand="lnkfpAutorization_Command"></asp:LinkButton>--%>
                                                        <a href="" target="_blank" runat="server" id="fpAutorization_a" visible="false">View Document</a>
                                        ...
                                        3rd, 4th radio to 1st, 2nd radio
                                                ...
                                                <div class="col-12 form-group row mb-3" id="div_civilid_publi_authority" runat="server">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        ...
                                                        <%--<asp:LinkButton ID="lnkfpcivilpubicauthority" runat="server" Text="View" OnCommand="lnkfpcivilpubicauthority_Command"></asp:LinkButton>--%>
                                                        <a href="" target="_blank" runat="server" id="fpcivilpubicauthority_a" visible="false">View Document</a>
                                        ...
                                        4th radio to 1st, 2nd radio
                                                ...
                                                <div class="col-12 form-group row mb-3" id="div_civilid_public_papper" runat="server">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        ...
                                                        <%--<asp:LinkButton ID="lnkfpcivilidpublicpapper" runat="server" OnCommand="lnkfpcivilidpublicpapper_Command"></asp:LinkButton>--%>
                                                        <a href="" target="_blank" runat="server" id="fpcivilidpublicpapper_a" visible="false">View Document</a>
                                        ...
                                        1st, 2nd, 3rd, 4th, 5th radio to 1st, 2nd radio
                                            ...
                                            <!--أو الفعالية-->
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        ...
                                                        <%--<asp:LinkButton ID="lnktxtBookApproval" runat="server" Text="View" OnCommand="lnktxtBookApproval_Command"></asp:LinkButton>--%>
                                                        <a href="" target="_blank" runat="server" id="txtBookApproval_a" visible="false">View Document</a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col">
                                                                                <div class="input-group date">
                                                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                                    <asp:TextBox runat="server" ID="txtActivityDate" Text='<%# dateFormat(Eval("txtActivityDate","{0:yyyy/MM/dd}").ToString()) %>' onkeypress="return false;" onpaste="return false;" CssClass="form-control input-rounded"></asp:TextBox>
                                                                        ...
                                                                        <td>
                                                                            <div class="col">
                                                                                ...
                                                                                <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator17" ControlToValidate="txtActivity" CssClass="red"
                                                                                    ErrorMessage="يرجى تعبئه البيانات باللغه العربيه" Display="Dynamic" SetFocusOnError="true" ValidationExpression="[^a-zA-Z]+"
                                                                                    ValidationGroup="submitionform"> </asp:RegularExpressionValidator>
                                                                                <asp:HiddenField runat="server" ID="hdExecutiveID" Value='<%# Eval("id").ToString() %>' />
                                                                            </div>
                                                                        </td>
                                                                ...
                                                                <td>
                                                                    <p align="center" dir="RTL">
                                                                        <asp:LinkButton ID="lnkExcutiveCanecl" runat="server" Text="-" OnClick="lnkExcutiveCanecl_Click" Visible="false"
                                                                            ...
                                                                            ValidationGroup="persExecutive" OnClientClick="ConfirmDel();" />
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
...
2MB 
                                                    ...
                                                    <div class="col-sm-8 col-xs-12 pull-right">
                                                        ...
                                                        <a id="fpexecutiveplan_a" runat="server" target="_blank" href="" visible="false">View </a>
                                                                ...
                                                                <asp:Repeater ID="rpDetails" runat="server" OnItemCommand="rpDetails_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <asp:UpdatePanel runat="server" ID="txtdetails">
                                                                                            <ContentTemplate>
                                                                                                <div class="input-group date">
                                                                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                                                    <asp:TextBox ID="txtDate" runat="server" Text='<%# Eval("txtDate","{0:dd-MM-yyyy}").ToString() %>' onkeypress="return false;" onpaste="return false;" CssClass="form-control"></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                <div class=" col-12 col">
                                                                                    <asp:FileUpload runat="server" ID="fbCv" CssClass="form-control" ClientIDMode="AutoID" onchange='<%# "return showpreview(ctl00_ContainerAR_rpDetails_ctl0" + Container.ItemIndex + "_fbCv,1)" %>' />
                                                                                    <a href='<%# Eval("txtCv").ToString() %>' target="_blank" runat="server" id="anchor">View Document</a>
                                                                                    <%--<asp:LinkButton ID="lnkfbCv" runat="server" Text="View"   CommandArgument='<%# Eval("txtCv").ToString() %>' CommandName ="download"></asp:LinkButton>--%>
                                                                                    ...
                                                                                    <%--   <asp:CustomValidator ID="CustomValidator1" ErrorMessage="حقول مطلوبة " runat="server" Display="Dynamic" OnServerValidate="CustomValidator1_ServerValidate"
                                                                             ValidationGroup="submitionform" CssClass="red" SetFocusOnError="true"></asp:CustomValidator>--%>
                                                                            ...
                                                                            <td>
                                                                                <div class=" col-12 col">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator41" runat="server"
                                                                                        ...
                                                                                        Display="Dynamic" SetFocusOnError="true" ValidationGroup="submitionform"></asp:RequiredFieldValidator>
                                                                                    <asp:HiddenField runat="server" ID="hddetailsID" Visible="true" Value='<%# Eval("id").ToString() %>' />
                                                                                    <%--<asp:Label ID="lbl" runat="server" Text='<%# Eval("id").ToString() %>'></asp:Label>--%>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                    ...
                                                                    <td>
                                                                        <p style="float: left;" dir="RTL">
                                                                            <asp:LinkButton ID="lnkDetailCancel" runat="server" Text="-" OnClick="lnkDetailCancel_Click" Visible="false"
                                                                                Style="font-size: 27px; color: #F00; font-weight: 600; text-decoration: none" Font-Size="13px" Font-Underline="true"
                                                                                ValidationGroup="persDetails" OnClientClick="ConfirmDel();" />
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <div class="col-sm-9 col-xs-12 pull-right">
                                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                        <div class="input-append">
                                                                            ...
                                                                            <%-- <asp:LinkButton ID="lnkfpconferencewrkingpapper" runat="server" OnCommand="lnkfpconferencewrkingpapper_Command"></asp:LinkButton>--%>
                                                                            <a href="" target="_blank" runat="server" id="fpconferencewrkingpapper_a" visible="false">View Document</a>
                                        ...
                                        1st, 2nd, 3rd, 4th, 5th radio to 1st, 2nd radio
                                                ...
                                                <div class="col-12 form-group row mb-3">
                                                    <h3 class="col-sm-3 pull-right">الخطة الإعلامية    
...
"><i class="fa fa-question-circle"></i></asp:Label>
                                                                        ...
                                                                        <td>
                                                                            <div class="col">
                                                                                ...
                                                                                <asp:RegularExpressionValidator
                                                                                    ...
                                                                                    ValidationExpression="^\d+?$"
                                                                                    CssClass="red" SetFocusOnError="true" />
                                                                                <asp:HiddenField runat="server" ID="hdMediaID" Value='<%# Eval("id").ToString() %>' />
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <p style="float: left;" dir="RTL">
                                                                        <asp:LinkButton ID="lnkMediaCancel" runat="server" Text="-" OnClick="lnkMediaCancel_Click" Visible="false"
                                                                            Style="font-size: 27px; color: #F00; font-weight: 600; text-decoration: none" Font-Size="13px" Font-Underline="true"
                                                                            ValidationGroup="persMedia" OnClientClick="ConfirmDel();" />
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <div class="col-12 form-group row mb-3">
                                                    <h3 class="col-sm-3 pull-right">الخطة المالية
                                                    </h3>
                                                            ...
                                                            <asp:Repeater ID="RPBudget" runat="server" OnItemCommand="RPBudget_ItemCommand">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:RegularExpressionValidator
                                                                        ...
                                                                        ValidationExpression="^\d+?$"
                                                                        CssClass="red" SetFocusOnError="true" />--%>
                                                                                <asp:HiddenField runat="server" ID="hdBudgetID" Value='<%# Eval("id").ToString() %>' />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                                ...
                                                                <td>
                                                                    <p style="float: left;" dir="RTL">
                                                                        <asp:LinkButton ID="lnkBugetCancel" runat="server" Text="-" OnClick="lnkBugetCancel_Click" Visible="false"
                                                                            Style="font-size: 27px; color: #F00; font-weight: 600; text-decoration: none" Font-Size="13px" Font-Underline="true"
                                                                            ValidationGroup="Vbudget" OnClientClick="ConfirmDel();" />
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <asp:Repeater ID="rpSponser" runat="server" OnItemCommand="rpSponser_ItemCommand">
                                                                ...
                                                                ValidationGroup="submitionform"></asp:RequiredFieldValidator>--%>
                                                                                <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator20" ControlToValidate="txtCareDetails" CssClass="red"
                                                                                    ErrorMessage="يرجى تعبئه البيانات باللغه العربيه" Display="Dynamic" SetFocusOnError="true" ValidationExpression="[^a-zA-Z]+"
                                                                                    ValidationGroup="submitionform"> </asp:RegularExpressionValidator>
                                                                                <asp:HiddenField runat="server" ID="hdSponsorID" Value='<%# Eval("id").ToString() %>' />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                                ...
                                                                <td>
                                                                    <p style="float: left;" dir="RTL">
                                                                        <asp:LinkButton ID="lnkSponserCanel" runat="server" Text="-" OnClick="lnkSponserCanel_Click" Visible="false"
                                                                            Style="font-size: 27px; color: #F00; font-weight: 600; text-decoration: none" Font-Size="13px" Font-Underline="true"
                                                                            ValidationGroup="persSponser" OnClientClick="ConfirmDel();" />
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <div class="col-sm-9 col-xs-12 pull-right">
                                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                                            <div class="input-append">
                                                                ...
                                                                <%--<asp:LinkButton ID="lnktxtCvofapplicant" runat="server" Visible="true" OnCommand="lnktxtCvofapplicant_Command"></asp:LinkButton>--%>
                                                                <a href="" target="_blank" runat="server" id="txtCvofapplicant_a" visible="false">View Document</a>
                                                ...
                                                <asp:Panel runat="server" ID="Panelcivil">
                                                    <div class="col-12 form-group row mb-3">
                                                        <label class="col-sm-3 control-label text-lg-left pt-2" for="inputRounded">
                                                            صورةالبطاقة المدنية
                                                        </label>
                                                        <div class="col-sm-9 col-xs-12 pull-right">
                                                            ...
                                                            <a href="" id="filecivil_a" runat="server" target="_blank" visible="false">View </a>
                                                            <div class="input-append">
                                        ...
                                        <%--<Triggers>
                                <asp:PostBackTrigger  ControlID="lnktxtBookApproval" />
                                <asp:PostBackTrigger  ControlID="lnkfpCivilID" />
                                <asp:PostBackTrigger  ControlID="lnkfpAutorization" />
                                <asp:PostBackTrigger  ControlID="lnkfpcivilpubicauthority" />
                                <asp:PostBackTrigger  ControlID="lnkfpcivilidpublicpapper" />                                

                                <asp:PostBackTrigger  ControlID="lnkfpconferencewrkingpapper" />

                                <asp:PostBackTrigger  ControlID="lnktxtCvofapplicant" />
