...
public partial class Policy : System.Web.UI.Page
{
    ...
    public void LoadAbout()
    {
        ...
        try
        {
           // DS = clsGeneral.GetDS("select REPLACE(REPLACE(PageContent, CHAR(13), '\r\n'), CHAR(10), '\r\n') as PageContent from MYA_Maleabna_PageContent where pid=2", GstrDbKey, "Table", true);
        ...
        catch (Exception ex)
        {
            ...
            pAbout.InnerHtml = dt.Rows[0]["message"].ToString().Trim();
        }
        finally
        {
