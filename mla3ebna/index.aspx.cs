...
public partial class index : System.Web.UI.Page
{
    ...
    public string Dateset = "اليوم/الشهر/السنة";
    ...
    protected void lnkGetStadiumData_Click(object sender, EventArgs e)
    {
        ...
        if (!date.Equals("NaN-NaN-NaN"))
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "alert", "alert('Check the date!!!!!');", true);
    ...
    {
        DataTable dt = fn_CheckWholeSiteBlock(hiddenDate.Value.ToString());
        DataColumnCollection columns = dt.Columns;
