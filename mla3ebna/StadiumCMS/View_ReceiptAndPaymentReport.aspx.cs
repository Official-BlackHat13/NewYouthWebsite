...
public partial class View_MembersReport : System.Web.UI.Page
{
    ...
    private void fillData()
    {
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            decimal totinc = dt.AsEnumerable().Sum(row => row.Field<decimal>("Income"));
            decimal totexp = dt.AsEnumerable().Sum(row => row.Field<decimal>("Expence"));
            

            GVData.FooterRow.Cells[0].Text = "Total  :";
            GVData.FooterRow.Cells[0].HorizontalAlign = HorizontalAlign.Right;
            GVData.FooterRow.Cells[0].CssClass = "footerStyle";
            GVData.FooterRow.Cells[1].CssClass = "footerStyle";
            GVData.FooterRow.Cells[2].CssClass = "footerStyle";
            //GVData.FooterRow.Cells[3].CssClass = "footerStyle";
            //GVData.FooterRow.Cells[4].CssClass = "footerStyle";
            GVData.FooterRow.Cells[1].Text = totinc.ToString();
            GVData.FooterRow.Cells[2].Text = totexp.ToString();
            //GVData.FooterRow.Cells[3].Text = total.ToString();
    ...
    private DataTable LoadData()
    {
        ...
        if (!string.IsNullOrEmpty(TxtFromDate.Text))
        {
            ...
            str = str + ",( cast(rpdate As date) between ''" + TxtFromDate.Text + "'' and ''" + TxtToDate.Text + "'')" + " ";
        ...
        cmd = "exec dbo.SP_MYA_Maleabna_GetRAndPMonthWise '" + str + "'";
    ...
    {
        Response.Redirect("View_ReceiptAndPaymentReport.aspx");
    }
