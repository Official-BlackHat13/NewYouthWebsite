...
public partial class View_MembersReport : System.Web.UI.Page
{
    ...
    private DataTable LoadData()
    {
       ...
       if (!DDLGovernorate.SelectedValue.Equals("0") && DDLGovernorate.SelectedValue != "")
            str = str + ",@govid='" + DDLGovernorate.SelectedValue+"' ";

       if (!DDLArea.SelectedValue.Equals("0") && DDLArea.SelectedValue != "")
            str = str + ",@areaid='" + DDLArea.SelectedValue + "' ";


       if (!DDLSchool.SelectedValue.Equals("0") && DDLSchool.SelectedValue != "")
            str = str + ",@schoolid='" +DDLSchool.SelectedValue + "' ";


       if (!DDLStadium.SelectedValue.Equals("0") && DDLStadium.SelectedValue != "")
            str = str + ",@stadiumid='" +DDLStadium.SelectedValue+ "' ";

       if (!DDLTimeSlot.SelectedValue.Equals("0"))
            str = str + ",@timeslot ='" +DDLTimeSlot.SelectedItem.Text.Trim() + "' ";

       if (!DDLOther.SelectedValue.Equals("0"))
        {
            if (DDLOther.SelectedValue == "1")
                str = str + ",@civil ='" + TxtOther.Text.Trim() + "' ";
        ...
        if (!DDLday.SelectedValue.Equals("0"))
            str = str + ",@day='" + DDLday.SelectedItem.Text + "'";
