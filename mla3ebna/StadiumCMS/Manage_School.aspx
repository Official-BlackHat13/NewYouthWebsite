<%@ Page Title="" Language="C#" MasterPageFile="StadiumCMSMasterPage.master" AutoEventWireup="true" CodeFile="Manage_School.aspx.cs" Inherits="StadiumCMS_Manage_School" %>
                ...
                <div class="col-lg-12">
                    <div class="element-wrapper">
                          <div class="element-actions">
                            <a class="btn btn-success btn-sm" href="Create_School.aspx"><i class="os-icon os-icon-ui-22"></i><span>&nbsp;إضافة مدرسة</span></a>
                        </div>
                        <h6 class="element-header">بحث مدرسة</h6>
                        <div class="element-box-tp">

                            <asp:UpdatePanel ID="updateschool" runat="server">
                                <ContentTemplate>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView Width="100%" ID="GVData" OnPageIndexChanging="OnPageIndexChanging"
                                            ...
                                            PageSize="50" GridLines="Horizontal" AllowPaging="true" DataKeyNames="SchoolID" ShowFooter="false">
                                            ...
                                            <Columns>
                                                <asp:TemplateField Visible="true">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="labItemID" Visible="false" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "SchoolID")%>'></asp:Label>
                                                        <asp:CheckBox ID="cb" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="SchoolID" Visible="false" ReadOnly="True"></asp:BoundField>
                                                <asp:BoundField DataField="SchoolName"  HeaderText="اسم"></asp:BoundField>
                                                <asp:BoundField DataField="ContactPersonName" HeaderText="ContactPersonName"></asp:BoundField>
                                               
                                                <asp:BoundField DataField="ContactPersonMobile" HeaderText="ContactPersonMobile"></asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="الحالة" ItemStyle-CssClass="text-center"
                                                    ...
                                                    <asp:TemplateField HeaderText="عرض"  ItemStyle-CssClass="text-center"
                                                        HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate><a href="View_SchoolDetails.aspx?SchoolID=<%#DataBinder.Eval(Container.DataItem, "SchoolID")%>" class="mr-2 mb-2 btn btn-outline-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                          <%--  <a href='Create_School.aspx?ID=<%#DataBinder.Eval(Container.DataItem, "SchoolID")%>'
