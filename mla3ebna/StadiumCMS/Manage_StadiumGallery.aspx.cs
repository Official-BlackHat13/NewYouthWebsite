...
public partial class StadiumCMS_Manage_StadiumGallery : System.Web.UI.Page
{
    ...
    private void fillStadiumGalleryDataToEdit()
    {
        ...
        dt = dbFunctions.GetData("select * from [MYA_Maleabna_Stadium_Gallery] where id=" + Request.QueryString["id"]);
        //Try
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            if (!DBNull.Value.Equals(dt.Rows[0]["Photo"]))
            {
                ...
                img_pic.Src =  System.Configuration.ConfigurationManager.AppSettings["StadiumGallery"] + dt.Rows[0]["Photo"].ToString();
                labPhotoFile.Text = dt.Rows[0]["Photo"].ToString();
            }
            else
            {
                img_pic.Visible = false;
    ...
    private void fillStadiumGalleryData()
    {
        ...
        cmd = "select * from [MYA_Maleabna_Stadium_Gallery] where StadiumID = "+ Request.QueryString["StadiumID"]+ "  order by [Sort] asc ";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (btnAdd.Text != "Modify")
        {
            ...
            if (file != "")
            {
                ...
                uFile.PostedFile.SaveAs(Server.MapPath(System.Configuration.ConfigurationManager.AppSettings["StadiumGallery"]) + file);
                ...
                sqlCommand.CommandText = "insert into MYA_Maleabna_Stadium_Gallery(StadiumID,Title,Photo) values(@StadiumID,@Title,@Photo)";
                ...
                sqlCommand.Parameters.AddWithValue("@Photo", file);
        ...
        else
        {
            ...
            sqlCommand.CommandText = "update MYA_Maleabna_Stadium_Gallery set Title=@Title,Photo=@Photo where id=@id";
    ...
    protected void img_del_Click(object sender, ImageClickEventArgs e)
    {
        ...
        for (i = 0; i <= dg.Items.Count - 1; i++)
        {
            ...
            {
                cmd = "delete from [MYA_Maleabna_Stadium_Gallery] where [id] = " + dg.Items[i].Cells[1].Text;
                dbFunctions.ExecuteQuery(cmd);
    ...
    public void lnkSort_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i <= dg.Items.Count - 1; i++)
        {
            ...
            sqlCommand.CommandText = "update MYA_Maleabna_Stadium_Gallery set sort=@sort where id=@id";
