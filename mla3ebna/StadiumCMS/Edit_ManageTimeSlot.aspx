<%@ Page Title="" Language="C#" MasterPageFile="StadiumCMSMasterPage.master" AutoEventWireup="true" CodeFile="Edit_ManageTimeSlot.aspx.cs" Inherits="Edit_ManageTimeSlot" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            dtString = $("#<%=hiddendateto.ClientID%>").val();
            dtString = dtString.split('/');
            var defaultDate = new Date(dtString[2], dtString[0], dtString[1]); //yyyy/MM/dd
            $('#<%=TxtToDate.ClientID %>').datepicker("setDate", defaultDate);
        });
    </script>
                    ...
                    <div class="element-wrapper">
                        ...
                        <div class="element-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                     ...
                                     <asp:Repeater ID="rptTime" runat="server" OnItemCommand="rptTime_ItemCommand" OnItemDataBound="rptTime_ItemDataBound">
                                        <ItemTemplate>
                                            <div class="row">

                                                <asp:HiddenField ID="repeaterid" runat="server" />
                                                <div class="col-sm-5">
                                                      <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <asp:LinkButton ID="lnkcancel" runat="server" Text="-" OnClick="lnkcancel_Click" OnClientClick="DeleteConfirmation();" CssClass="btn btn-primary" ></asp:LinkButton>
                                    </div>
                                </div>
                            ...
                            <div class="form-buttons-w">
                                ...
                                <asp:LinkButton ID="lnkAddTime" OnClick="lnkAddTime_Click"  ValidationGroup="MainValidate" runat="server" CssClass="btn btn-primary"> <i class="os-icon os-icon-ui-22"></i>&nbsp;Update</asp:LinkButton>

                                <asp:LinkButton ID="lnkCanceltime" PostBackUrl="~/mla3ebna/StadiumCMS/ViewTimeSlot.aspx" runat="server" CssClass="btn btn-danger mr-1" ><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Cancel</asp:LinkButton>
