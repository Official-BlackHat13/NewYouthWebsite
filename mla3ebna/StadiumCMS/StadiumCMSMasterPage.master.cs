...
public partial class StadiumCMS_StadiumCMSMasterPage : System.Web.UI.MasterPage
{
    ...
    private void fillMobileMenu()
    {
        ...
        if (Session["MaleabnaCMSUsersMenu"].ToString() == "True")
        {
            ...
            {
                strMobileMenu = strMobileMenu + " <li class='selected'><a href='Default.aspx'><div class='icon-w'><div class='fa fa-home'></div> </div><span>الرئيسية</span></a> </li>";
            }
            else
            {
                strMobileMenu = strMobileMenu + " <li class=''><a href='Default.aspx'><div class='icon-w'><div class='fa fa-home'></div> </div><span>الرئيسية</span></a> </li>";
            ...
            {               
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='Manage_CMSUsers.aspx'><div class='icon-w'><div class='os-icon os-icon-user-male-circle2'></div> </div><span>فريق العمل</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='Manage_CMSUsers.aspx'><div class='icon-w'><div class='os-icon os-icon-user-male-circle2'></div> </div><span>فريق العمل</span></a> </li>";
                }
            ...
            if (Session["MaleabnaCMSSettingsMenu"].ToString() == "True")
            {
                ...
                if (Request.Url.ToString().IndexOf("Manage_Governorate.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_Area.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_School.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_Stadium.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_Guard.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_PageContent.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_SuspendedActivities.aspx") != -1 | Request.Url.ToString().IndexOf("Manage_TermsConditionsText.aspx") != -1)
                {
                    ...
                    strMobileMenu = strMobileMenu + "<li class='has-sub-menu'><a href='#'><div class='icon-w'> <div class='fa fa-cog'></div></div><span>الاعدادات</span></a>";

                    //strMobileMenu = strMobileMenu + "  <div class='sub-menu-w'><div class='sub-menu-header'>الاعدادات</div> <div class='sub-menu-icon'><div class='os-icon os-icon-user-male-circle2'></div> </div>";
                    //strMobileMenu = strMobileMenu + "<div class='sub-menu-i'>";

                    strMobileMenu = strMobileMenu + "<ul class='sub-menu'>";


                    strMobileMenu = strMobileMenu + " <li><a href='Manage_Governorate.aspx'>المحافظة</a></li>";
                    strMobileMenu = strMobileMenu + " <li><a href='Manage_Area.aspx'>المنطقة</a></li>";

                    strMobileMenu = strMobileMenu + " <li><a href='Manage_Guard.aspx'>Guard</a></li>";
                    //strMobileMenu = strMobileMenu + "</ul>";

                    //strMobileMenu = strMobileMenu + "<ul class='sub-menu'>";

                    strMobileMenu = strMobileMenu + " <li><a href='ViewTimeSlot.aspx'>Time Slot</a></li>";

                    strMobileMenu = strMobileMenu + "</ul>";


                    //strMobileMenu = strMobileMenu + "</div>";
                    //strMobileMenu = strMobileMenu + "</div>";
                ...
                else
                {
                    ...
                    //strMobileMenu = strMobileMenu + "  <div class='sub-menu-w'><div class='sub-menu-header'>الاعدادات</div> <div class='sub-menu-icon'><div class='fa fa-cog'></div> </div>";
                    //strMobileMenu = strMobileMenu + "<div class='sub-menu-i'>";
            ...
            if (Session["MaleabnaCMSStadiumMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='Manage_School.aspx'><div class='icon-w'><div class='fa fa-building-o'></div> </div><span>مدرسة</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='Manage_School.aspx'><div class='icon-w'><div class='fa fa-building-o'></div> </div><span>مدرسة</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSStadiumMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='Manage_Stadium.aspx'><div class='icon-w'><div class='fa fa-map-marker'></div> </div><span>الملعب</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='Manage_Stadium.aspx'><div class='icon-w'><div class='fa fa-map-marker'></div> </div><span>الملعب</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSMembersMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='View_Members.aspx'><div class='icon-w'><div class='fa fa-address-card'></div> </div><span>Members</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='View_Members.aspx'><div class='icon-w'><div class='fa fa-address-card'></div> </div><span>Members</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSBookingMenu"].ToString() == "True")
            {
                ...
                if (Request.Url.ToString().IndexOf("View_Members.aspx") != -1 | Request.Url.ToString().IndexOf("View_MembersDetails.aspx") != -1)
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='View_Booking.aspx'><div class='icon-w'><div class='fa fa-calendar'></div> </div><span>حجوز</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='View_Booking.aspx'><div class='icon-w'><div class='fa fa-calendar '></div> </div><span>حجوز</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSReportsMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='View_BookingReport.aspx'><div class='icon-w'><div class='os-icon os-icon-bar-chart-up'></div> </div><span>تقارير</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='View_BookingReport.aspx'><div class='icon-w'><div class='os-icon os-icon-bar-chart-up'></div> </div><span>تقارير</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSPagesMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + "<li class='has-sub-menu'><a href='#'><div class='icon-w'> <div class='os-icon os-icon-file-text'></div></div><span>Pages</span></a>";

                    //strMobileMenu = strMobileMenu + "  <div class='sub-menu-w'><div class='sub-menu-header'>Pages</div> <div class='sub-menu-icon'><div class='os-icon os-icon-file-text'></div> </div>";
                    //strMobileMenu = strMobileMenu + "<div class='sub-menu-i'>";

                    strMobileMenu = strMobileMenu + "<ul class='sub-menu'>";
                    strMobileMenu = strMobileMenu + " <li><a href='Add_Modify_PageContent.aspx?PID=5'>Introduction</a></li>";
                    strMobileMenu = strMobileMenu + " <li><a href='Add_Modify_PageContent.aspx?PID=1'>عن ملعبنا</a></li>";
                    strMobileMenu = strMobileMenu + " <li><a href='Add_Modify_PageContent.aspx?PID=2'>سياسة الخصوصية</a></li>";
                    strMobileMenu = strMobileMenu + " <li><a href='Add_Modify_PageContent.aspx?PID=3'>سياسة الحجز</a></li>";
                    strMobileMenu = strMobileMenu + " <li><a href='Add_Modify_PageContent.aspx?PID=4'>الإتصال بنا</a></li>";
            ...
            if (Session["MaleabnaCMSBannerMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='Manage_Banner.aspx'><div class='icon-w'><div class='os-icon os-icon-documents-07'></div> </div><span>Banner</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='Manage_Banner.aspx'><div class='icon-w'><div class='os-icon os-icon-documents-07'></div> </div><span>Banner</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSBlockStadiumMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='View_BlockStadium.aspx'><div class='icon-w'><div class='fa fa-ban'></div> </div><span>Block Stadium</span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='View_BlockStadium.aspx'><div class='icon-w'><div class='fa fa-ban'></div> </div><span>Block Stadium</span></a> </li>";
                }
            }
            ...
            if (Session["MaleabnaCMSContactMenu"].ToString() == "True")
            {
                ...
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='View_ContactUs.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> ContactUs </span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='View_ContactUs.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> ContactUs </span></a> </li>";
                }
            }


            if (Session["MaleabnaAdmin"].ToString() == "Admin")
            {
                if (Request.Url.ToString().IndexOf("Add_StadiumAreaCode.aspx") != -1)
                {
                    strMobileMenu = strMobileMenu + " <li class='selected'><a href='Add_StadiumAreaCode.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> Area Code </span></a> </li>";
                }
                else
                {
                    strMobileMenu = strMobileMenu + " <li class=''><a href='Add_StadiumAreaCode.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> Area Code </span></a> </li>";
                }
            }
    ...
    private void fillMenu()
    {
        ...
        if (Session["MaleabnaAdmin"].ToString() == "Admin")
        {
            if (Request.Url.ToString().IndexOf("Add_StadiumAreaCode.aspx") != -1)
            {
                strMenu = strMenu + " <li class='selected'><a href='Add_StadiumAreaCode.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> Area Code </span></a> </li>";
            }
            else
            {
                strMenu = strMenu + " <li class=''><a href='Add_StadiumAreaCode.aspx'><div class='icon-w'><div class='fa fa-pencil'></div> </div><span> Area Code </span></a> </li>";
            }
        }
