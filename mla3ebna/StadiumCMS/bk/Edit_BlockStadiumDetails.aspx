<%@ Page Title="" Language="C#" MasterPageFile="StadiumCMSMasterPage.master" AutoEventWireup="true" CodeFile="Edit_BlockStadiumDetails.aspx.cs" Inherits="Edit_BlockStadiumDetails" %>
                ...
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        <div class="element-actions">
                            ...
                            <a class="btn btn-success btn-sm" href="Block_Stadium.aspx"><i class="os-icon os-icon-ui-49"></i><span>&nbsp; BlockStadium</span></a>
                        </div>
                        ...
                        <div class="element-box">
                            ...
                            <div class="form-buttons-w">
                                ...
                                <asp:LinkButton ID="lnkAdd" OnClick="lnkAdd_Click" OnClientClick="return CallConfirmBox();" ValidationGroup="MainValidate" runat="server" CssClass="btn btn-primary"> <i class="os-icon os-icon-ui-22"></i>&nbsp;Modify</asp:LinkButton>

                                <asp:LinkButton ID="lnkCancel" runat="server" PostBackUrl="~/View_BlockStadium.aspx" CssClass="btn btn-danger mr-1"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Cancel</asp:LinkButton>
