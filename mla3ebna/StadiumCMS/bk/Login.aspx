    ...
    <div class="all-wrapper menu-side with-pattern">
      <div class="auth-box-w">
       ...
       <form id="form1" runat="server">
          ...
          <div class="buttons-w">
              <asp:LinkButton ID="lnkLogin" OnClick="lnkLogin_Click" CssClass="btn btn-success" runat="server" ValidationGroup="MainValidiateLogin"><i class="ft-unlock"></i>  تسجيل الدخول</asp:LinkButton>
