...
public partial class StadiumCMS_View_Booking : System.Web.UI.Page
{
    ...
    private DataTable LoadData()
    {
        ...
        //    str = str + ",UserID=" + DDlUser.SelectedValue + " ";
        if (TextUser.Text != "")
            str = str + ",UserFullName Like '%" + TextUser.Text + "%' ";
        ...
        {
            // DateTime strFromDate, StrToDate;
        ...
        str = str + ",BookingStatus = " + DDLbookingStatus.SelectedValue;
        //if (TxtName.Text != "")
        //{
    ...
    protected void DDLCancel_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if(confirm_value == "Yes")
        {
            ...
            string Btime = GVData.Rows[rowIndex].Cells[3].Text;
            string Stadium = GVData.Rows[rowIndex].Cells[4].Text;
    ...
    private string CancellationDetails(string BDate, string Btime, string Stadium)
    {
        ...
        text = text + "Booing Date:" + BDate + " <br />"; //booking Date
        text = text + "Booing Time:" + Btime + "<br/>"; ; //booking time
        text = text + "Stadium Name:" + Stadium + "<br/>"; ; //StadiumName
    ...
    private bool email(string email, string cancellationDetails, string CancellationTxtByAdmin)
    {
        ...
        int i = SendEmail.GeneralEmail(email, text);
        if (i == 0)
            return true;
        else
            return false;
