...
public partial class StadiumCMS_ChangePassword : System.Web.UI.Page
{
    public void lnkUpdate_Click(object sender, EventArgs e)
    {
        ...
        cmd = "select [password] from [MYA_Maleabna_CMSUsers] where username='" + Session["MaleabnaCMSUsername"] + "'  ";
        ...
        if (p != "")
        {
            ...
            {
                cmd = "update [MYA_Maleabna_CMSUsers] set [password]='" + txtnewpassword.Text + "' where [username]='" + Session["MaleabnaCMSUsername"] + "' ";
                try
                {
                    dbFunctions.ExecuteQuery(cmd);
                    CMSUserActivityLog.CreateUserActivityLog(CMSCurrentUser.MaleabnaCMSUserID, CMSCurrentUser.MaleabnaCMSName, "ChangePassword", "ChangePassword", DateTime.Now, "", "", "");
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        txtUsername.Text = Session["MaleabnaCMSUsername"].ToString();
    }
