                ...
                <div class="col-sm-12">
                    <div class="element-wrapper">
                        ...
                        <div class="element-content">
                            ...
                            <div class="row" id="PanSiteStatistics" runat="server">
                                ...
                                <div class="col-sm-9 col-xxl-8">
                                    ...
                                    <div class="element-wrapper">
                                        ...
                                        <div class="element-box" style="min-height: 450px;">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtdate" AutoComplete="off" CssClass="form-control " runat="server" AutoPostBack="true" OnTextChanged="txtdate_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="element-box">
                                            ...
                                            <a class="btn btn-round  btn-outline-success" href='javascript:void(0);' onclick="openWinPrint()"><i class='fa fa-print'></i></a>
                                            ...
                                            <asp:LinkButton ID="LinkExcel" runat="server" CssClass="btn btn-round  btn-outline-success" OnClick="LinkExcel_Click"><span class="fa fa-file-excel-o"></span> </asp:LinkButton>
                                        </div>
