...
public partial class StadiumCMS_View_MemberDetails : System.Web.UI.Page
{
    ...
    {
        DataTable dt;
        dt = dbFunctions.GetData("select Name,CivilID,[V_Members].Email,Phone,GovernorateName,StadiumName,format(BookingDate,'dd/MM/yyyy') as BookingDate,BookingTime from [V_Booking] join [V_Members] on  V_Booking.UserID = V_Members.UserID where BookingStatus = '1' and [V_Members].UserID=" + Request.QueryString["UserID"] + " order by BookingDate desc");
