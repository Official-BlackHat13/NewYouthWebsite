<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_BookingReport.aspx.cs" Inherits="Print_BookingReport" %>
        ...
        <table width="100%" cellpadding="2" cellspacing="2">
            ...
            <tr>
                <td align="center" class="Legendtitle">
                    <asp:Label ID="labMainTitle" runat="server" Text="Booking Report"></asp:Label>
                </td>
            </tr>
            <tr>
                <td height="30"></td>
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="LblBookingDate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "BookingDate")%>'></asp:Label>
                                    </td>


                                    <td >

                                        <asp:Label ID="LblBookingTime" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "BookingTime")%>'></asp:Label>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="LblArea" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "AreaName")%>'></asp:Label>
                                    </td>
                                    <td class="">

                                        <asp:Label ID="LabStadiumName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "StadiumName")%>'></asp:Label>
                                    ...
                                    <td >
                                        ...
                                        <asp:Label ID="LblRegDate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "CreatedAt")%>'></asp:Label>
