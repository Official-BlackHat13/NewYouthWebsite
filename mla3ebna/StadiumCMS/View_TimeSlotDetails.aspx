                                ...
                                <div class="side-section">
                                    <script type="text/javascript">
                                        ...
                                        function openWinPrint(id) {
                                            window.open("Print_TimeSlotDetails.aspx?TimeSlotMasterID=" + id + '', "_blank", "toolbar=no, location=no, directories=no, status=yes, menubar=no, scrollbars=yes, resizable=yes, copyhistory=no,width=700,height=650");
                                        }
