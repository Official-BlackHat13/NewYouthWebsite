<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="StadiumCMS_Login" %>
    ...
    <div class="all-wrapper menu-side with-pattern">
      <div class="auth-box-w">
        <div class="logo-w"><%--<span class="loginTittle">Dr.Esraa Clinic</span>--%>
          <a href="Default.aspx"><img alt="" src="Design/img/MaleabnaLogoH.png"></a>
        </div>
       ...
       <form id="form1" runat="server">
          ...
          <div class="buttons-w">
              <asp:LinkButton ID="lnkLogin" OnClick="lnkLogin_Click" CssClass="btn btn-success" runat="server" CausesValidation="false" ValidationGroup="MainValidiateLogin"><i class="ft-unlock"></i>  تسجيل الدخول</asp:LinkButton>
