                             ...
                             <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="">
                                            SportType
                                            <asp:RequiredFieldValidator ValidationGroup="MainValidate" CssClass="require" InitialValue="0" ControlToValidate="DDLSportType" ID="RequiredFieldValidator4" runat="server" ErrorMessage="(يرجى إدخال اسم الملعب)"></asp:RequiredFieldValidator></label>
                                        <asp:DropDownList ID="DDLSportType" runat="server" CssClass="chzn-select chzn-rtl" ></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <%--<asp:RegularExpressionValidator ID="regKuwaitFinderNumber" runat="server" ValidationExpression="^[0-9]*$" CssClass="text-danger" ControlToValidate="TxtKuwaitfinderNumber" 
                                            SetFocusOnError="true" ValidationGroup="MainValidate" ErrorMessage="Please Enter Kuwiat Finder Number"></asp:RegularExpressionValidator>--%>

                                         <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^[0-9]*$" ValidationGroup="MainValidate" 
                                            CssClass="text-danger" ErrorMessage="Please Enter Kuwiat Finder Number" SetFocusOnError="true" ControlToValidate="TxtKuwaitfinderNumber"></asp:RegularExpressionValidator>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="reggoole" runat="server" ValidationExpression="^(-?\d+(\.\d+)?),\s*(-?\d+(\.\d+)?)$" ValidationGroup="MainValidate" 
                                            CssClass="text-danger" ErrorMessage="write latitue and longitude" SetFocusOnError="true" ControlToValidate="TxtGoogleMapLocation"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
