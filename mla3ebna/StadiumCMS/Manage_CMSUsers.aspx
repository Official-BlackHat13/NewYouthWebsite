                ...
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        ...
                        <div class="element-box-tp">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <asp:LinkButton ID="lnkDelete" runat="server" CssClass="btn btn-round btn-sm btn-danger" OnClick="lk_del_Click"><i class="os-icon os-icon-ui-15"></i>&nbsp;Delete</asp:LinkButton>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                           <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded" OnPageIndexChanged="dg_PageIndexChanged"
