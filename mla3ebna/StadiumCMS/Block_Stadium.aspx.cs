...
public partial class Block_Stadium : System.Web.UI.Page
{
    ...
    private void fillStadiumCourt()
    {
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            //    DDLStadiumCourt.SelectedValue = dt.Rows[0]["StadiumDetId"].ToString();
    ...
    protected void lnkAdd_Click(object sender, EventArgs e)
    {
       ...
       if (hdviewstate.Value.ToString() == "No" && lblerror.Text == "")
        {
            string cmd;
        ...
        else if( hdviewstate.Value.ToString() == "Booked")
        {            
    ...
    private void CheckBlockAvailable(string strStadiumCourtId)
    {
        ...
        {
            dbFunctions.ExecuteQuery("exec SP_UpdateBookingInfoAfterWholeSIteBlock '" + TxtFromDate.Text + "','" + TxtToDate.Text + "'");
        }
    ...
    protected void fillTimeSlot()
    {
        ...
        dt = dbFunctions.GetData("exec SP_GetTImeSlots @DtFrm='"+TxtFromDate.Text+"',@DtTo='"+ TxtToDate.Text +"', @govid='" + (DDLGovernorate.SelectedValue == "0" ? "" : DDLGovernorate.SelectedValue) + "',@areaid='" + (DDLArea.SelectedValue == "0" ? "" : DDLArea.SelectedValue) + "',@schoolid='" + (DDLSchool.SelectedValue == "0" ? "" : DDLSchool.SelectedValue) + "',@stadiumID='" + (DDLStadium.SelectedValue == "0" ? "" : DDLStadium.SelectedValue) + "',@userid=" + Session["MaleabnaCMSUserID"]);
    ...
    protected void EmailSend()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            int res = CMSSendEmail.GeneralEmail(email, txtReason.Text);           
