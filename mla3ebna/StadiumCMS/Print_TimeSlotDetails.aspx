<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_TimeSlotDetails.aspx.cs" Inherits="mla3ebna_StadiumCMS_Print_TimeSlotDetails" %>
        ...
        <table width="100%" cellpadding="2" cellspacing="2">
            ...
            <tr>
                <td align="center" class="Legendtitle">
                    <asp:Label ID="labMainTitle" runat="server" Text="TimeSlot"></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                <td class="" colspan="2" align="center">
                    <span class="btxt_orange ">TYPE :</span>
            ...
            <tr>
                <td align="center">
                    <table class="btxt_1 bdrtbl" dir="rtl" width="95%" cellpadding="5" cellspacing="0" id="RptTable">
                        <tr>
                            <th><span class="btxt_orange ">TimeSlot</span></th>
                        </tr>
