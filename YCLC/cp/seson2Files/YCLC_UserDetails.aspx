<%@ Page Title="" Language="C#" MasterPageFile="cpanl.master" AutoEventWireup="true" CodeFile="YCLC_UserDetails.aspx.cs" Inherits="YCLC_cp_YCLC_UserDetails" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <div class="candidates-item" style="direction: rtl">
        ...
        <div class="gridView" style="direction: rtl">
            ...
            <asp:Repeater ID="comptetionrepeater" runat="server">
                <ItemTemplate>
