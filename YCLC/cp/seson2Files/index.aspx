...
<head>
    ...
    <link rel="stylesheet" href="../../YCL/CP/css/style.default.css" type="text/css" />   
</head>
    ...
    <div class="loginwrapper">
        <div class="loginwrap zindex100 animate2 bounceInDown">
            <div class="logintitle">
                <img src="../../YCL/img/logo.png" style="float: left;"><br>
            ...
            <div class="loginwrapperinner">
                <form id="loginform" runat="server">
                    ...
                    <asp:Panel runat="server" ID="Pnl_Password" Visible="false">
                       ...
                       <p class="animate4 bounceIn"> <asp:TextBox runat="server"  placeholder="Username" CssClass="username" ID="txtEmail"></asp:TextBox> </p>
                        <p class="animate6 bounceIn"><asp:Button runat="server" ID="bt" CssClass="loginbutton btn btn-default btn-block"
                            Text="Login"  OnClick="bt_Click"></asp:Button> </p>
                        <p class="animate7 fadeIn">
                            <asp:LinkButton runat="server" id="lloginpnl" onclick="lloginpnl_Click"><span class="icon-question-sign icon-white"></span>Submit</asp:LinkButton>
