...
public partial class YCLC_cp_YCLC_WaitingListUserDetails : System.Web.UI.Page
{
    ...
    {
        int id = (int.Parse)(Session["yclc_wuserid"].ToString());
        ...
        using (cnn)
        {
            SqlCommand viewcommand = new SqlCommand("SP_YCLCompetition_waiting", cnn);
    ...
    protected void BtSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem item in comptetionrepeater.Items)
        {
            ...
            cnn.ConnectionString = gm.ConnectionString();
            cnn.Open();
            SqlCommand viewcommand = new SqlCommand("SP_YCLCompetitionUpdation_Waiting", cnn);
            viewcommand.CommandType = CommandType.StoredProcedure;
