<%@ Page Title="" Language="C#" MasterPageFile="~/YCLC/cp/cpanl.master" AutoEventWireup="true" CodeFile="YCLC_ViewWaitingList.aspx.cs" Inherits="YCLC_cp_YCLC_ViewWaitingList" %>
    ...
    <div class="mediamgr_head">
        <ul class="mediamgr_menu">
            ...
            <li class="col-md-12 col-sm-4 col-xs-12 pd">
                 <asp:Panel runat="server" ID="pnlOrg" Visible="false">
                ...
                <div class="col-md-1 col-sm-1 pull-right ad_input">
    ...
    <asp:GridView ID="competetionGrid" runat="server" CssClass="table table-bordered" EmptyDataText="No Records Found" AllowSorting="true" AutoGenerateColumns="false" OnRowCommand="competetionGrid_RowCommand" AllowPaging="true"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="البريد الالكتروني">
             ...
             <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="إختر مسابقة">
                <ItemTemplate>
                    <%# Eval("Category")  %>
                </ItemTemplate>
            </asp:TemplateField>
