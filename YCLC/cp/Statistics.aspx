<%@ Page Title="" Language="C#" MasterPageFile="cpanl.master" AutoEventWireup="true" CodeFile="Statistics.aspx.cs" Inherits="MYA2_aceStatistics" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="mainContent" runat="Server">
    <div class="contentinner">
        ...
        <asp:GridView ID="grdAce" CssClass="table table-bordered" OnRowCommand="grdAce_RowCommand" runat="server" Width="100%" Style="direction: rtl" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="count ">
                    <ItemTemplate>
                        <span class="nf">
                            <asp:Label runat="server" ID="lblName" Text='<%# Eval("val")%>'></asp:Label>
                            <asp:LinkButton ID="lnkcatView" ToolTip="click to print" runat="server" Text='<%# Eval("val")%>' CommandArgument='<%#Eval("Catgeory_name")%>'  Visible="false" CommandName="catview"></asp:LinkButton>
                        </span>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                </asp:TemplateField>
