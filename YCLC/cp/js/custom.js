...
jQuery(document).ready(function(){
	...
	if (jQuery('#mainContent_datepicker').length > 0) {

	    jQuery("#mainContent_datepicker").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });
	}

	if (jQuery('#mainContent_datepicker1').length > 0)
	    jQuery("#mainContent_datepicker1").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });
		

	if (jQuery('#mainContent_datepicker2').length > 0)
	    jQuery("#mainContent_datepicker2").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });


	if (jQuery('#mainContent_datepicker3').length > 0)
	    jQuery("#mainContent_datepicker3").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });
	if (jQuery('#mainContent_datepicker4').length > 0)
	    jQuery("#mainContent_datepicker4").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });

	if (jQuery('#mainContent_txtSalaryDate').length > 0)
	    jQuery("#mainContent_txtSalaryDate").datepicker({
	        changeMonth: true,
	        changeYear: true
	    });
