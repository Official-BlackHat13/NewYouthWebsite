                    ...
                    <div class="row">
                        <div class="col-xs-12 text-right">
                            ...
                            <div class="heading-bg">
                                <h1 class="form-style">في حال الرغبة بالتسجيل كجهة يرجى التسجيل بإسم الشخص المفوض</h1>
                            </div>
...
إختر مسابقة
                                                        ...
                                                        <div class="col-sm-8">
                                                            <asp:CheckBoxList ID="DDLCatagory" runat="server" CssClass="" ClientIDMode="Static" Enabled="false"  RepeatDirection="Horizontal">
                                                            </asp:CheckBoxList>
                                                    ...
                                                    <div class="req">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <span  class="red"> بحد اقصى يمكنك اختيار مسابقتين</span>
                                                        </div>
                                                ...
                                                <asp:Panel runat="server" ID="pnlSub" Visible="false">
                                                    <div class="form-group">
                                                           <div class="row" style="direction: rtl;">
                                                                 <div class="col-sm-3">
                                                        <label class="control-label">المسابقة المتاحة</label></div>
...
يمكنك اختيار أي مجال آخر متاح لك
    ...
    <script type="text/javascript">
        ...
        function EndRequestHandler()
        {
            ...
            $('#DDLCatagory').on('click', ':checkbox', function () {
                if ($(this).is(':checked')) {                   
                    $("[id*=DDLCatagory] input:checked").each(function () {                       
                        selectedValues.push($(this).val());
                    });
                    
                    if (selectedValues.length > limit) {                                        
                        $("[id*=DDLCatagory] input:checkbox[value=" + $("#hiddenCategory").val() + "]").prop("checked", false);
