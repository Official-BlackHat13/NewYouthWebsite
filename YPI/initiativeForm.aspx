                            ...
                            <div class="col-xs-12 text-right">
                                ...
                                <div class="heading-bg">
                                  ...
                                  <asp:Panel runat="server" ID="divFormPanel" Visible="true">
                                    <div class="form-horizontal">
                                        <div class="cont col-xs-12"><div class="col-12 form-group row mb-3 text-center" style="display:none;">
 <div class="text-center txtnotered">ملاحظة : سوف يتم استخدام Microsoft teams  للتدريب او الدراسة  عن بعد وبمجرد تسجيلك سوف يتم تزويدك بالبيانات (اسم المستخدم وكلمة المرور عبر بريدك الإلكتروني الخاص )خلال 24 ساعة</div></div><br />
                                            <div class="col-sm-12">
                                                <div class="form-row ">
                                                    ...
                                                    <asp:UpdatePanel ID="experienceupdatepanel" runat="server">
                                                        <ContentTemplate>
                                                            <div class="col-12 form-group row mb-3">
                                                                ...
                                                                <label class="col-sm-3 control-label pt-2" for="inputRounded">
                                                                    مقدم الطلب
                                                                </label>
                                                            ...
                                                            <asp:UpdatePanel runat="server" ID="updWhere"><ContentTemplate>
