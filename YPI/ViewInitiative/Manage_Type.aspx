<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_Type.aspx.cs" Inherits="ViewInitiative_Manage_Type" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        ...
                        <h6 class="element-header">تعديل مقدم الطلب</h6>
                                        ...
                                        <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="NameAr" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true"
                                                    HeaderText="مقدم الطلب"></asp:BoundColumn>
