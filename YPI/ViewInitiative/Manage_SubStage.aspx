<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_SubStage.aspx.cs" Inherits="ViewInitiative_Manage_SubStage" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        <h6 class="element-header">Sub Stage</h6>
                        <div class="element-box">

                            <h5 class="form-header">Add Departments</h5>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="">
                                            Stage  
                                            <asp:CustomValidator runat="server" ID="custPermitType" CssClass="require" ControlToValidate="DDLStage"
                                                SetFocusOnError="true" ValidationGroup="MainValidate" ClientValidationFunction="CheckDropDownValueZero"
                                                ErrorMessage="(يرجى إدخال  Stage )" />
                                        </label>
                                        <asp:DropDownList CssClass="chzn-select chzn-rtl" OnSelectedIndexChanged="DDLStage_SelectedIndexChanged"  ID="DDLStage" AutoPostBack="true" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="element-wrapper">
                        ...
                        <h6 class="element-header">تعديل Sub Stage</h6>
                                        ...
                                        <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="NameAr" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true"
                                                    HeaderText="Sub Stage"></asp:BoundColumn>
