<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_Status.aspx.cs" Inherits="ViewInitiative_Manage_Status" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        ...
                        <h6 class="element-header">تعديل الحالة  مبادراتنا</h6>
                                           ...
                                           <HeaderStyle CssClass="panel-blue"></HeaderStyle>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="NameAr" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true"
                                                    HeaderText="الحالة  مبادراتنا"></asp:BoundColumn>
