<%@ Page Title="" Language="C#" MasterPageFile="~/ViewInitiative/ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="AppUserOld.aspx.cs" Inherits="ViewInitiative_AppUserOld" %>
                        ...
                        <div class="element-box">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control" ID="DDLUserGroups" OnSelectedIndexChanged="DDLInstitution_SelectedIndexChanged" AutoPostBack="false" runat="server">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control" ID="DDLInstitution" OnSelectedIndexChanged="DDLInstitution_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                            <asp:ListItem Value="1">MYA</asp:ListItem>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control" ID="DDLStage" AutoPostBack="false" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    <div class="form-group">
                                        <label for="projectinput2">&nbsp;</label>
                                        <asp:CheckBox ID="CH_DropDowns" Text="&nbsp; الاعدادات" CssClass="form-control" runat="server" />
                                    </div>
                                </div>
