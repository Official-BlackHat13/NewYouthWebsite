<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_AppUsers.aspx.cs" Inherits="ViewInitiative_Manage_AppUsers" %>
                ...
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        <div class="element-actions">
                            <a class="btn btn-success btn-sm" href="Create_AppUsers.aspx"><i class="os-icon os-icon-ui-22"></i><span>&nbsp; إضافة فريق العمل </span></a>
                        </div>
                                           ...
                                           <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="تعديل" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle"
                                                    ...
                                                    <ItemTemplate>
                                                        <a href="Create_AppUsers.aspx?id=<%#DataBinder.Eval(Container.DataItem, "UserID")%>" class="btn btn-info btn-sm"><i class="os-icon os-icon-ui-49"></i></a>
