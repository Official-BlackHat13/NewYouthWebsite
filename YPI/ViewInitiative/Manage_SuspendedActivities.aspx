<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_SuspendedActivities.aspx.cs" Inherits="ViewInitiative_Manage_SuspendedActivities" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        <h6 class="element-header">الأنشطة الموقوفة</h6>
                        <div class="element-box">

                            <h5 class="form-header">Add الأنشطة الموقوفة</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="">
                                           الأنشطة الموقوفة
                                            <asp:RequiredFieldValidator ValidationGroup="MainValidate" CssClass="require" ControlToValidate="TxtName" ID="RequiredFieldValidator1" runat="server" ErrorMessage="(يرجى إدخال الأنشطة الموقوفة)"></asp:RequiredFieldValidator></label><asp:TextBox ID="TxtName" runat="server" CssClass="form-control" ></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="NameAr" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true"
                                                    HeaderText="الأنشطة الموقوفة"></asp:BoundColumn>
