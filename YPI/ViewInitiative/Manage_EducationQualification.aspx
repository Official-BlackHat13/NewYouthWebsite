<%@ Page Title="" Language="C#" MasterPageFile="ViewInitiativeMasterPage.master" AutoEventWireup="true" CodeFile="Manage_EducationQualification.aspx.cs" Inherits="ViewInitiative_Manage_EducationQualification" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="element-wrapper">
                        ...
                        <h6 class="element-header">المؤهل الدراسي</h6>
                        <div class="element-box-tp">

                            <div class="row ">
                                <div class="col-md-4">
                                    <asp:LinkButton ID="lnkDelete" Visible="false" runat="server" CssClass="btn btn-round btn-sm btn-danger"><i class="os-icon os-icon-ui-15"></i>&nbsp;Delete</asp:LinkButton>
                                </div>
                                        ...
                                        <asp:DataGrid ID="dg" runat="server" Width="100%" CssClass="table table-padded"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="NameAr" HeaderStyle-CssClass="TxtBlueColor" HeaderStyle-Font-Bold="true"
                                                    HeaderText="الفئة مبادراتنا"></asp:BoundColumn>
