!function(e, t) {
    ...
    return function(e) {
        ...
        var i = Object.assign || function(e) {
            ...
            return j = i(j, e), w = (0, h.default)(), z(j.disable) || x ? S() : (document.querySelector("div").setAttribute("data-aos-easing", j.easing), 
            document.querySelector("div").setAttribute("data-aos-duration", j.duration), document.querySelector("div").setAttribute("data-aos-delay", j.delay), 
            "DOMContentLoaded" === j.startEvent && [ "complete", "interactive" ].indexOf(document.readyState) > -1 ? O(!0) : "load" === j.startEvent ? window.addEventListener(j.startEvent, function() {
                ...
                O(!0);
            }), window.addEventListener("resize", (0, f.default)(O, j.debounceDelay, !0)), window.addEventListener("orientationchange", (0, 
            f.default)(O, j.debounceDelay, !0)), window.addEventListener("scroll", (0, u.default)(function() {
        ...
        var n = function(e) {
            for (var t = 0, n = 0; e && !isNaN(e.offsetLeft) && !isNaN(e.offsetTop); ) t += e.offsetLeft - ("div" != e.tagName ? e.scrollLeft : 0), 
            n += e.offsetTop - ("div" != e.tagName ? e.scrollTop : 0), e = e.offsetParent;
            return {
                top: n,
                left: t
            };
